...
export default function Contact() {
  return (
    <div className="min-h-screen bg-white px-6 py-32">
      <div className="max-w-3xl mx-auto">
        ...
        >
          <h1
            className="text-5xl lg:text-6xl font-semibold text-gray-900 mb-6 tracking-tight"
            style={{ fontFamily: 'var(--font-apple-display)' }}
          >
            Get in Touch
          </h1>
          <p className="text-xl max-w-2xl mx-auto font-light leading-relaxed" style={{ color: '#86868b' }}>
          ...
          >
            <div className="flex items-center space-x-5">
              ...
              <div>
                ...
                <p className="font-light" style={{ color: '#86868b' }}>matgnt@icloud.com</p>
              </div>
            </div>
          ...
          >
            <div className="flex items-center space-x-5">
              ...
              <div>
                ...
                <p className="font-light" style={{ color: '#86868b' }}>github.com/MathGnt</p>
              </div>
            </div>
            <div className="opacity-0 group-hover:opacity-100 group-hover:translate-x-1 transition-all duration-300">
              <svg className="w-5 h-5" style={{ color: '#86868b' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          >
            <div className="flex items-center space-x-5">
              ...
              <div>
                ...
                <p className="font-light" style={{ color: '#86868b' }}>linkedin.com/in/mathisgnt</p>
              </div>
            </div>
            <div className="opacity-0 group-hover:opacity-100 group-hover:translate-x-1 transition-all duration-300">
              <svg className="w-5 h-5" style={{ color: '#86868b' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
